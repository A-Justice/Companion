...
namespace Companion_1._0.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/Companion 1.0;component/Resources/Resource Dictionaries/HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/Companion 1.0;component/Resources/Resource Dictionaries/Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/Companion 1.0;component/Resources/Resource Dictionaries/SnowFlakes.xaml", UriKind.Relative) });
